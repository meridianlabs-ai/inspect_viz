...
[![](images/scores_by_task.png)](images/scores_by_task.png)

[![](images/scores_by_model.png)](images/scores_by_model.png)

[![](images/scores_timeline_gpqa.png)](images/scores_timeline_gpqa.png)
...
Interactivity is built in. The [scores_timeline()](./view-scores-timeline.html.md) view, for example, lets visitors filter by benchmark and organization and hover for tooltips that link to the underlying Inspect logs[^1]:
...
1gpqa = Data.from_file("gpqa.parquet")
...
3        fill="model_organization_name",
4        channels= {
...
2  
Plot using a [dot()](./reference/inspect_viz.mark.html.md#dot) mark. The [plot()](./reference/inspect_viz.plot.html.md#plot) function takes one or more marks or interactors.

3  
Map the “model_organization_name” column to the `fill` scale of the plot (causing each orgnization to have its own color).
