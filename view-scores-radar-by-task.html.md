# Scores Radar By Task – Inspect Viz
...
7  
Provide an optional task name mapping for pretty task names in [prepare()](https://inspect.aisi.org.uk/reference/inspect_ai.analysis.html#prepare).
...
[Source](https://github.com/meridianlabs-ai/inspect_viz/blob/f2f2eff657128a6418485a6eabd9462f979cb727/src/inspect_viz/view/_scores_radar.py#L277)
...
A [Data](./reference/inspect_viz.html.md#data) object prepared using the `scores_radar_by_task_df` function.
...
Additional [PlotAttributes](./reference/inspect_viz.plot.html.md#plotattributes). Use `margin` to set custom margin (defaults to max(60, width \* 0.12)).
...
[Source](https://github.com/meridianlabs-ai/inspect_viz/blob/f2f2eff657128a6418485a6eabd9462f979cb727/src/inspect_viz/view/_scores_radar.py#L33)
...
The [Scores Radar By Task](./examples/inspect/scores-radar-by-task/index.html.md) example demonstrates how this view was implemented using lower level plotting components.
