...
The [sample_tool_calls()](./reference/inspect_viz.view.html.md#sample_tool_calls) function creates a heat map visualising tool calls over evaluation turns for each sample.
...
The [Sample Tool Calls](./examples/inspect/sample-tool-calls/index.html.md) example demonstrates how this view was implemented using lower level plotting components.
