...
The [scores_heatmap()](reference/inspect_viz.view.html.md#scores_heatmap)function renders a heatmap for comparing eval scores.
...
The [Scores Heatmap](examples/inspect/scores-heatmap/index.html.md) example demonstrates how this view was implemented using lower level plotting components.
