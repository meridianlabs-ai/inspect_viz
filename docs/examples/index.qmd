...
| [Scores Radar By Task](inspect/scores-radar-by-task/index.qmd) |  Radar plot comparing multiple models across headline metrics from different evals. |
| [Scores Radar By Metric](inspect/scores-radar-by-metric/index.qmd) |  Radar plot for comparing model scores across multiple metrics from a single eval. |
