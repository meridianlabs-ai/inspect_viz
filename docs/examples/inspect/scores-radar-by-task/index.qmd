...
subtitle: "Dataset: [radar_by_task.parquet](radar_by_task.parquet)"
datafile: "radar_by_task.parquet"
---

This example illustrates the code behind the [`scores_radar_by_task()`](../../../view-scores-radar-by-task.qmd) pre‑built view function. If you want to include this plot in your notebooks or sites, start with that function rather than the lower‑level code below.
