---
title: "Inspect Viz"
llms-description: A high level overview of the entire library.
subtitle: |
...
::: {layout-ncol=3}
![](images/scores_by_task.png){group="hero-plots"}

![](images/scores_by_model.png){group="hero-plots"}

![](images/scores_timeline_gpqa.png){group="hero-plots"}
:::
...
Interactivity is built in. The [`scores_timeline()`](view-scores-timeline.qmd) view, for example, lets visitors filter by benchmark and organization and hover for tooltips that link to the underlying Inspect logs[^1]:
...
The [`scores_by_task()`](view-scores-by-task.qmd) view enables you to compare scores across models on each evaluation task:
