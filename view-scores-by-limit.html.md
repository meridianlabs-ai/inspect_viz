...
2.  Be sure to specify the [SampleSummary](https://inspect.aisi.org.uk/reference/inspect_ai.analysis.html#samplesummary), [EvalInfo](https://inspect.aisi.org.uk/reference/inspect_ai.analysis.html#evalinfo), and [EvalModel](https://inspect.aisi.org.uk/reference/inspect_ai.analysis.html#evalmodel) columns.
3.  Convert the base dataframe into a [scores_by_limit()](reference/inspect_viz.view.html.md#scores_by_limit) specific dataframe.
