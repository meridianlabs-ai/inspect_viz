...
Select inputs have a `target` which is either a [Param](../reference/inspect_viz.html.md#param) or [Selection](../reference/inspect_viz.html.md#selection). In the latter case, the `field` parameter determines the data column name to use within generated selection clause predicates (defaulting to `column`). If no `target` is specified then the data source’s selection is used as the target.
...
[Source](https://github.com/meridianlabs-ai/inspect_viz/blob/da0a73dfe16a54cafe18cb65dc40676bab93e9cc/src/inspect_viz/input/_select.py#L10)
...
Initial value for selection. Pass “all” (the default) for no filtering, “auto” to select the first element in the list, or value(s) for an explicit initial selection. Applies only when `target` is a [Selection](../reference/inspect_viz.html.md#selection) (as [Param](../reference/inspect_viz.html.md#param) carries its own default value).

`multiple` bool  
Enable selection of multiple values (defaults to `False`)

`target` [Param](../reference/inspect_viz.html.md#param) \| [Selection](../reference/inspect_viz.html.md#selection) \| None  
A [Param](../reference/inspect_viz.html.md#param) or [Selection](../reference/inspect_viz.html.md#selection) that this select input should update. For a [Param](../reference/inspect_viz.html.md#param), the selected value is set to be the new param value. For a [Selection](../reference/inspect_viz.html.md#selection), a predicate of the form column = value will be added to the selection.
...
[Source](https://github.com/meridianlabs-ai/inspect_viz/blob/da0a73dfe16a54cafe18cb65dc40676bab93e9cc/src/inspect_viz/input/_slider.py#L10)
...
`target` [Param](../reference/inspect_viz.html.md#param) \| [Selection](../reference/inspect_viz.html.md#selection) \| None  
A [Param](../reference/inspect_viz.html.md#param) or [Selection](../reference/inspect_viz.html.md#selection) that this select input should update. For a [Param](../reference/inspect_viz.html.md#param), the selected value is set to be the new param value. For a [Selection](../reference/inspect_viz.html.md#selection), a predicate that does an equality check (for `select=="point"`) or range check (for `select=="interval"`).
...
[Source](https://github.com/meridianlabs-ai/inspect_viz/blob/da0a73dfe16a54cafe18cb65dc40676bab93e9cc/src/inspect_viz/input/_search.py#L10)
...
`target` [Param](../reference/inspect_viz.html.md#param) \| [Selection](../reference/inspect_viz.html.md#selection) \| None  
A [Param](../reference/inspect_viz.html.md#param) or [Selection](../reference/inspect_viz.html.md#selection) that this search box should update. For a [Param](../reference/inspect_viz.html.md#param), the textbox value is set as the new param value. For a [Selection](../reference/inspect_viz.html.md#selection), a predicate based on the `type` option will be added to the selection.
...
Checkboxes have a `target` which is either a [Param](../reference/inspect_viz.html.md#param) or [Selection](../reference/inspect_viz.html.md#selection). In the latter case, the `field` parameter determines the data column name to use within generated selection clause predicates (defaulting to `column`). If no `target` is specified then the data source’s selection is used as the target.
...
[Source](https://github.com/meridianlabs-ai/inspect_viz/blob/da0a73dfe16a54cafe18cb65dc40676bab93e9cc/src/inspect_viz/input/_checkbox.py#L8)
...
`target` [Param](../reference/inspect_viz.html.md#param) \| [Selection](../reference/inspect_viz.html.md#selection) \| None  
A [Param](../reference/inspect_viz.html.md#param) or [Selection](../reference/inspect_viz.html.md#selection) that this checkbox should interact with (use `values` to customize the values that are used in the `target`).

`field` str \| None  
The data column name to use within generated selection clause predicates (required if `target` is not a [Param](../reference/inspect_viz.html.md#param)).
...
Radio groups have a `target` which is either a [Param](../reference/inspect_viz.html.md#param) or [Selection](../reference/inspect_viz.html.md#selection). In the latter case, the `field` parameter determines the data column name to use within generated selection clause predicates (defaulting to `column`). If no `target` is specified then the data source’s selection is used as the target.

The intitial selected value will be “All” when `target` is a [Selection](../reference/inspect_viz.html.md#selection) (indicating select all records) and the param value when `target` is a [Param](../reference/inspect_viz.html.md#param).

[Source](https://github.com/meridianlabs-ai/inspect_viz/blob/da0a73dfe16a54cafe18cb65dc40676bab93e9cc/src/inspect_viz/input/_radio_group.py#L8)
...
`target` [Param](../reference/inspect_viz.html.md#param) \| [Selection](../reference/inspect_viz.html.md#selection) \| None  
A [Param](../reference/inspect_viz.html.md#param) or [Selection](../reference/inspect_viz.html.md#selection) that this radio group should update. For a [Param](../reference/inspect_viz.html.md#param), the selected value is set to be the new param value. For a [Selection](../reference/inspect_viz.html.md#selection), a predicate of the form column = value will be added to the selection.
...
Checkbox groups have a `target` which is either a [Param](../reference/inspect_viz.html.md#param) or [Selection](../reference/inspect_viz.html.md#selection). In the latter case, the `field` parameter determines the data column name to use within generated selection clause predicates (defaulting to `column`). If no `target` is specified then the data source’s selection is used as the target.
...
[Source](https://github.com/meridianlabs-ai/inspect_viz/blob/da0a73dfe16a54cafe18cb65dc40676bab93e9cc/src/inspect_viz/input/_checkbox_group.py#L8)
