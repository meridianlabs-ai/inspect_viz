...
[Source](https://github.com/meridianlabs-ai/inspect_viz/blob/f2f2eff657128a6418485a6eabd9462f979cb727/src/inspect_viz/view/_scores_by_task.py#L20)
...
Additional [PlotAttributes](../reference/inspect_viz.plot.html.md#plotattributes). By default, the `margin_bottom` are is set to 10 pixels and `x_ticks` is set to `[]`.
...
[Source](https://github.com/meridianlabs-ai/inspect_viz/blob/f2f2eff657128a6418485a6eabd9462f979cb727/src/inspect_viz/view/_scores_timeline.py#L29)
...
`data` [Data](../reference/inspect_viz.html.md#data)  
Data read using [evals_df()](https://inspect.aisi.org.uk/reference/inspect_ai.analysis.html#evals_df) and amended with model metadata using the [model_info()](https://inspect.aisi.org.uk/reference/inspect_ai.analysis.html#model_info) prepare operation (see [Data Preparation](https://inspect.aisi.org.uk/dataframe.html#data-preparation) for details).
...
`regression` bool  
If `True`, adds a regression line to the plot (uses the confidence interval passed using ci). Defaults to False.

`legend` [Legend](../reference/inspect_viz.plot.html.md#legend) \| NotGiven \| None  
Legend to use for the plot (defaults to `None`, which uses the default legend).

`**attributes` Unpack\[[PlotAttributes](../reference/inspect_viz.plot.html.md#plotattributes)\]  
Additional [PlotAttributes](../reference/inspect_viz.plot.html.md#plotattributes). By default, the `x_domain` is set to “fixed”, the `y_domain` is set to `[0,1.0]`, `color_label` is set to “Organizations”, and `color_domain` is set to `organizations`.
...
[Source](https://github.com/meridianlabs-ai/inspect_viz/blob/f2f2eff657128a6418485a6eabd9462f979cb727/src/inspect_viz/view/_scores_by_model.py#L19)
...
`**attributes` Unpack\[[PlotAttributes](../reference/inspect_viz.plot.html.md#plotattributes)\]  
Additional [PlotAttributes](../reference/inspect_viz.plot.html.md#plotattributes). By default, the `y_inset_top` and `margin_bottom` are set to 10 pixels and `x_ticks` is set to `[]`.

### scores_heatmap

Creates a heatmap plot of success rate of eval data.

[Source](https://github.com/meridianlabs-ai/inspect_viz/blob/f2f2eff657128a6418485a6eabd9462f979cb727/src/inspect_viz/view/_scores_heatmap.py#L16)
...
`cell` [CellOptions](../reference/inspect_viz.view.html.md#celloptions) \| None  
...
[Source](https://github.com/meridianlabs-ai/inspect_viz/blob/f2f2eff657128a6418485a6eabd9462f979cb727/src/inspect_viz/view/_sample_tool_calls.py#L18)
...
`data` [Data](../reference/inspect_viz.html.md#data)  
Messages data table. This is typically created using a data frame read with the inspect [messages_df()](https://inspect.aisi.org.uk/reference/inspect_ai.analysis.html#messages_df) function.
...
`**attributes` Unpack\[[PlotAttributes](../reference/inspect_viz.plot.html.md#plotattributes)\]  
Additional [PlotAttributes](../reference/inspect_viz.plot.html.md#plotattributes). By default, the `margin_top` is set to 0, `margin_left` to 20, `margin_right` to 100, `color_label` is “Tool”, `y_ticks` is empty, and `x_ticks` and `color_domain` are calculated from `data`.

### sample_heatmap

Creates a heatmap plot of success rate of eval data.

[Source](https://github.com/meridianlabs-ai/inspect_viz/blob/f2f2eff657128a6418485a6eabd9462f979cb727/src/inspect_viz/view/_sample_heatmap.py#L16)
...
[Source](https://github.com/meridianlabs-ai/inspect_viz/blob/f2f2eff657128a6418485a6eabd9462f979cb727/src/inspect_viz/view/_heatmap.py#L32)
...
[Source](https://github.com/meridianlabs-ai/inspect_viz/blob/f2f2eff657128a6418485a6eabd9462f979cb727/src/inspect_viz/view/_heatmap.py#L22)
