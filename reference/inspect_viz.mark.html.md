...
`x` [ChannelSpec](../reference/inspect_viz.mark.html.md#channelspec) \| [Param](../reference/inspect_viz.html.md#param)  
Horizontal position channel specifying the dot’s center.

`y` [ChannelSpec](../reference/inspect_viz.mark.html.md#channelspec) \| [Param](../reference/inspect_viz.html.md#param)  
The vertical position channel specifying the dot’s center.

`z` [Channel](../reference/inspect_viz.mark.html.md#channel) \| [Param](../reference/inspect_viz.html.md#param) \| None  
An optional ordinal channel for grouping data into series.

`r` [ChannelSpec](../reference/inspect_viz.mark.html.md#channelspec) \| float \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`rotate` [Channel](../reference/inspect_viz.mark.html.md#channel) \| float \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`symbol` [ChannelSpec](../reference/inspect_viz.mark.html.md#channelspec) \| [Param](../reference/inspect_viz.html.md#param) \| [Symbol](../reference/inspect_viz.mark.html.md#symbol) \| None  
...
`y` [ChannelIntervalSpec](../reference/inspect_viz.mark.html.md#channelintervalspec) \| None  
...
`x` [ChannelIntervalSpec](../reference/inspect_viz.mark.html.md#channelintervalspec) \| None  
...
`z` [ChannelSpec](../reference/inspect_viz.mark.html.md#channelspec) \| [Param](../reference/inspect_viz.html.md#param) \| None  
An optional ordinal channel for grouping data into series.
...
`rotate` [ChannelSpec](../reference/inspect_viz.mark.html.md#channelspec) \| float \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`data` [Data](../reference/inspect_viz.html.md#data) \| None  
The data source for the mark. If None, x and y must be provided as sequences.

`x` [ChannelSpec](../reference/inspect_viz.mark.html.md#channelspec) \| [Param](../reference/inspect_viz.html.md#param) \| None  
The required horizontal position channel, typically bound to the *x* scale. When data is None, must be a sequence of x-coordinates.

`y` [ChannelSpec](../reference/inspect_viz.mark.html.md#channelspec) \| [Param](../reference/inspect_viz.html.md#param) \| None  
The required vertical position channel, typically bound to the *y* scale. When data is None, must be a sequence of y-coordinates.

`z` [Channel](../reference/inspect_viz.mark.html.md#channel) \| [Param](../reference/inspect_viz.html.md#param) \| None  
An optional ordinal channel for grouping data into series. When data is None, can be a sequence of z-values.

`filter_by` [Selection](../reference/inspect_viz.html.md#selection) \| None  
Selection to filter by (defaults to data source selection).

`marker` [Marker](../reference/inspect_viz.mark.html.md#marker) \| bool \| [Param](../reference/inspect_viz.html.md#param) \| None  
Shorthand to set the same default for marker_start, marker_mid, and marker_end.

`marker_start` [Marker](../reference/inspect_viz.mark.html.md#marker) \| bool \| [Param](../reference/inspect_viz.html.md#param) \| None  
The marker for the starting point of a line segment.

`marker_mid` [Marker](../reference/inspect_viz.mark.html.md#marker) \| bool \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`x1` [ChannelSpec](../reference/inspect_viz.mark.html.md#channelspec) \| [Param](../reference/inspect_viz.html.md#param)  
...
`y1` [ChannelSpec](../reference/inspect_viz.mark.html.md#channelspec) \| [Param](../reference/inspect_viz.html.md#param)  
...
`x2` [ChannelSpec](../reference/inspect_viz.mark.html.md#channelspec) \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`y2` [ChannelSpec](../reference/inspect_viz.mark.html.md#channelspec) \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`offset` Literal\['center', 'normalize', 'wiggle'\] \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`x1` [ChannelSpec](../reference/inspect_viz.mark.html.md#channelspec) \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`y1` [ChannelSpec](../reference/inspect_viz.mark.html.md#channelspec) \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`x` [ChannelIntervalSpec](../reference/inspect_viz.mark.html.md#channelintervalspec) \| [Param](../reference/inspect_viz.html.md#param)  
...
`y` [ChannelIntervalSpec](../reference/inspect_viz.mark.html.md#channelintervalspec) \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`inset_top` float \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`inset_left` float \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`rx` str \| float \| [Param](../reference/inspect_viz.html.md#param) \| None  
The rounded corner [*x*-radius](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/rx), either in pixels or as a percentage of the rect width. If **rx** is not specified, it defaults to **ry** if present, and otherwise draws square corners.
...
`pixel_size` float \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`bandwidth` float \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`type` Literal\['dot', 'circle', 'hexagon', 'cell', 'text'\] \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`symbol` [Symbol](../reference/inspect_viz.mark.html.md#symbol) \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`type` Literal\['areaX', 'lineX', 'dotX', 'textX'\] \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`stack` bool \| [Param](../reference/inspect_viz.html.md#param) \| None  
Flag indicating if densities should be stacked. Defaults to `False`.

`bandwidth` float \| [Param](../reference/inspect_viz.html.md#param) \| None  
The kernel density bandwidth for smoothing, in pixels.

`bins` float \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`type` Literal\['areaY', 'lineY', 'dotY', 'circle', 'hexagon', 'textY'\] \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`thresholds` float \| list\[float\] \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`ci` float \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`rx` float \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`anchor` str \| [Param](../reference/inspect_viz.html.md#param) \| None  
The side of the frame on which to place the grid (*top* or *bottom*).

`color` [ChannelSpec](../reference/inspect_viz.mark.html.md#channelspec) \| str \| [Param](../reference/inspect_viz.html.md#param) \| None  
Shorthand for setting both fill and stroke color.

`ticks` int \| Sequence\[Any\] \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`type` Literal\['hexagon', 'dot', 'text'\] \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`multiple` float \| [Param](../reference/inspect_viz.html.md#param) \| None  
The number of units per tile; defaults to 1.

`unit` float \| [Param](../reference/inspect_viz.html.md#param) \| None  
The size of each unit in the waffle; defaults to 1.

`gap` float \| [Param](../reference/inspect_viz.html.md#param) \| None  
The gap between waffle units; defaults to 1.

`round` bool \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`origin` list\[float\] \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`length` [ChannelSpec](../reference/inspect_viz.mark.html.md#channelspec) \| float \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`shape` Literal\['arrow', 'spike'\] \| [Param](../reference/inspect_viz.html.md#param) \| None  
The shape of the vector; one of “arrow” or “spike”.

`anchor` Literal\['start', 'middle', 'end'\] \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`bend` float \| bool \| [Param](../reference/inspect_viz.html.md#param) \| None  
The angle between straight line and outgoing tangent (±90°, use True for 22.5°).

`head_angle` float \| [Param](../reference/inspect_viz.html.md#param) \| None  
How pointy the arrowhead is in degrees (0°-180°, defaults to 60°).

`head_length` float \| [Param](../reference/inspect_viz.html.md#param) \| None  
Size of arrowhead relative to stroke width.

`inset` float \| [Param](../reference/inspect_viz.html.md#param) \| None  
Shorthand for both inset_start and inset_end.

`inset_start` float \| [Param](../reference/inspect_viz.html.md#param) \| None  
Starting inset in pixels (defaults to 0).

`inset_end` float \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`normalize` bool \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`margin_top` int  
Top margin fot title (defaults to 10 pixels). You may need to increase this if there are facet labels on the x-axis that the title needs to be placed above.

`font_size` float \| None  
The font size in pixels (defaults to 14)

`font_family` str \| None  
The font-family (defaults to the plot’s font family, which is typically *system-ui*”)

`font_weight` float \| None  
The font weight (defaults to the plot’s font weight, which is typically 400.”
...
`anchor` Literal\['top', 'right', 'bottom', 'left'\] \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`text` [ChannelSpec](../reference/inspect_viz.mark.html.md#channelspec) \| [Param](../reference/inspect_viz.html.md#param) \| None  
The text channel for tick labels.

`frame_anchor` [FrameAnchor](../reference/inspect_viz.mark.html.md#frameanchor) \| [Param](../reference/inspect_viz.html.md#param) \| None  
The frame anchor specifies defaults for **x** and **y** based on the plot’s frame.

`line_anchor` str \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`text_stroke` [ChannelSpec](../reference/inspect_viz.mark.html.md#channelspec) \| [Param](../reference/inspect_viz.html.md#param) \| None  
The stroke color for text labels.

`text_stroke_opacity` [ChannelSpec](../reference/inspect_viz.mark.html.md#channelspec) \| float \| [Param](../reference/inspect_viz.html.md#param) \| None  
The stroke opacity for text labels.

`text_stroke_width` [ChannelSpec](../reference/inspect_viz.mark.html.md#channelspec) \| float \| [Param](../reference/inspect_viz.html.md#param) \| None  
The stroke width for text labels.

`styles` [TextStyles](../reference/inspect_viz.mark.html.md#textstyles) \| None  
[TextStyles](../reference/inspect_viz.mark.html.md#textstyles) to apply to axis text.
...
`tick_size` float \| [Param](../reference/inspect_viz.html.md#param) \| None  
The length of tick marks in pixels.

`tick_padding` float \| [Param](../reference/inspect_viz.html.md#param) \| None  
The distance between the tick mark and its label in pixels.

`tick_format` str \| [Param](../reference/inspect_viz.html.md#param) \| None  
A d3-format string for formatting tick labels.

`tick_rotate` float \| [Param](../reference/inspect_viz.html.md#param) \| None  
The rotation angle of tick labels in degrees clockwise.

`label` str \| [Param](../reference/inspect_viz.html.md#param) \| None  
The axis label text.

`label_offset` float \| [Param](../reference/inspect_viz.html.md#param) \| None  
The distance between the axis and its label in pixels.

`label_anchor` str \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`x` [ChannelIntervalSpec](../reference/inspect_viz.mark.html.md#channelintervalspec) \| [Param](../reference/inspect_viz.html.md#param) \| None  
The horizontal position channel, typically bound to the *x* scale.
...
`data` [Data](../reference/inspect_viz.html.md#data) \| None  
The data source for the mark (not required if not binding `text` to a column). If None, any of x, y, z, text can be provided as sequences.

`x` [ChannelSpec](../reference/inspect_viz.mark.html.md#channelspec) \| [Param](../reference/inspect_viz.html.md#param) \| None  
The horizontal position channel specifying the text’s anchor point, typically bound to the *x* scale. When data is None, can be a sequence of x-coordinates.

`y` [ChannelSpec](../reference/inspect_viz.mark.html.md#channelspec) \| [Param](../reference/inspect_viz.html.md#param) \| None  
The vertical position channel specifying the text’s anchor point, typically bound to the *y* scale. When data is None, can be a sequence of y-coordinates.

`z` [Channel](../reference/inspect_viz.mark.html.md#channel) \| [Param](../reference/inspect_viz.html.md#param) \| None  
An optional ordinal channel for grouping data into series. When data is None, can be a sequence of z-values.

`text` [Channel](../reference/inspect_viz.mark.html.md#channel) \| [Param](../reference/inspect_viz.html.md#param) \| None  
The text contents channel, possibly with line breaks (, , or . When data is None, can be a sequence of text values. To place a single piece of text specify the text as a string\[\] (e.g. `["My Text"]`).
...
`line_anchor` [LineAnchor](../reference/inspect_viz.mark.html.md#lineanchor) \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`data` [Data](../reference/inspect_viz.html.md#data) \| None  
The data source for the mark. If None, any of x, y, z, text can be provided as sequences.
...
`text` [Channel](../reference/inspect_viz.mark.html.md#channel) \| [Param](../reference/inspect_viz.html.md#param) \| None  
The text contents channel, possibly with line breaks (, , or . When data is None, can be a sequence of text values. If not specified, defaults to the zero-based index \[0, 1, 2, …\].

`interval` Interval \| [Param](../reference/inspect_viz.html.md#param) \| None  
An interval (such as *day* or a number), to transform **y** values to the middle of the interval.
...
`width` [Channel](../reference/inspect_viz.mark.html.md#channel) \| float \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`height` [Channel](../reference/inspect_viz.mark.html.md#channel) \| float \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`r` [Channel](../reference/inspect_viz.mark.html.md#channel) \| float \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`src` [Channel](../reference/inspect_viz.mark.html.md#channel) \| str \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`preserve_aspect_ratio` str \| [Param](../reference/inspect_viz.html.md#param) \| None  
The image aspect ratio; defaults to “xMidYMid meet”. To crop the image instead of scaling it to fit, use “xMidYMid slice”.

`cross_origin` str \| [Param](../reference/inspect_viz.html.md#param) \| None  
...
`geometry` [Channel](../reference/inspect_viz.mark.html.md#channel) \| [Param](../reference/inspect_viz.html.md#param) \| None  
