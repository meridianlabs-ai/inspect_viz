...
The [sample_heatmap()](./reference/inspect_viz.view.html.md#sample_heatmap)function renders a heatmap for viewing individual sample scores. Each sample is shown along one axis, models are shown along the other axis.
...
![](view-sample-heatmap_files/placeholder/2809ff4deb1e7425.png)
...
2.  Using the [prepare()](https://inspect.aisi.org.uk/reference/inspect_ai.analysis.html#prepare) function to [model_info()](https://inspect.aisi.org.uk/reference/inspect_ai.analysis.html#model_info) and [log_viewer()](https://inspect.aisi.org.uk/reference/inspect_ai.analysis.html#log_viewer) columns to the data frame.
...
The [Sample Heatmap](./examples/inspect/sample-heatmap/index.html.md) example demonstrates how this view was implemented using lower level plotting components.
