...
# def dataframe(data: IntoDataFrame | str | PathLike[str]) -> DataFrame:
...
#             widget: DataFrameWidget,
#             parent: Optional["DataFrameImpl"] = None,
#         ) -> None:
#             self._id = id
#             self._queries = queries
#             self._ndf = ndf
...
#             # create widget
#             widget = dataframe_widget(id=id, queries=to_json(queries).decode())
...
#     return DataFrameImpl(id=source_id, queries=[], ndf=ndf, widget=dataframe_widget())
