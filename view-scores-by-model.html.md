...
The [scores_by_model()](./reference/inspect_viz.view.html.md#scores_by_model) function creates a horizontal bar plot for comparing the scores of different models on a single evaluation, with one or more baselines overlaid as vertical lines.
...
The [Scores by Model](./examples/inspect/scores-by-model/index.html.md) example demonstrates how this view was implemented using lower level plotting components.
